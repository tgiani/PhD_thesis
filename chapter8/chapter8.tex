...
\begin{align}
	...
	\text{h}_{\gamma^0,3}\lp z P_z, z^2,\mu\rp = 
...
real and imaginary part of the ME $\text{h}_{\gamma^0,3}\lp z \rp$ to the
...
\begin{align}
	  \mathcal{O}_{\gamma^0}^{\text{Re}}&\lp z, \mu \rp 
		  \equiv \text{Re} \left[\text{h}_{\gamma^0,3}\lp z P_z, z^2, \mu^2 \rp\right] 
           \nonumber \\
	  ...
	  \mathcal{O}_{\gamma^0}^{\text{Im}}&\lp z, \mu \rp 
          \equiv \text{Im} \left[\text{h}_{\gamma^0,3}\lp z P_z, z^2, \mu^2 \rp\right]
          \nonumber \\ 
