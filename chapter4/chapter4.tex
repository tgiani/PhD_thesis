...
assessing the impact of jets and dijets production measurements on the PDFs, using the recent NNLO QCD computations
supplemented by EW corrections.
...
%
In this study we address these issues in the context of PDFs determination. We study the impact of both single-inclusive
...
%   
We observe a mild deterioration of the $\chi^2$ for to pair processes, with a value of 1.25 to be compared to
...
seems to be in tension with the ATLAS 8 TeV single-inclusive
jet data.

%
Concerning fit quality, the quality of the two fits \#janw and \#danw is comparable, though slightly better
...
%
Finally we note how the fit inclusive dijets data is somewhat more internally consistent than the one including
...
\subsection{Summary}
In this chapter we have presented a phenomenological investigation of inclusive jet
