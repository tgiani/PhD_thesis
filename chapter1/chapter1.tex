...
\comment{See also Ferrera's notes on quarks mass}
...
QCD on an Euclidean lattice, referring to standard textbooks as Refs.~\cite{smit_2002} for more details.
...
In the presence of a gauge filed $U_{\mu}$, Eq.~\eqref{eq:fermions_wilson_action} becomes 
\begin{align}
...
$O\left[\psi,\bar{\psi},A_{\mu}\right]$ can be evaluated
