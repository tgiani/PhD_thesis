...
The functional integral of Eq.~\ref{eq:euclidean_correlator} can be estimated
...
In the presence of a gauge filed $U_{\mu}$, Eq.~\ref{eq:fermions_wilson_action} becomes 
\begin{align}
