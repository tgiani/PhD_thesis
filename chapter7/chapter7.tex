...
We will consider a massive scalar field theory, with a
$\phi^3$ interaction term in $d=6$ dimensions, in order to have a marginal interaction.
The bare Lagrangian $\mathcal{L}$ is given by
\begin{align}
    \label{eq:Lagrangian}
...
\begin{figure}[h]
	...
	\label{fig:f_diag_1}
\end{figure}
Therefore the only Feynman diagrams contributing to eq.~\eqref{eq::LSZ} up to one-loop order are those shown in 
fig.~\ref{fig:f_diag_2}.
\begin{figure}[h]
        \centering
    \begin{tikzpicture}
    \begin{feynhand} 
...
We conclude this chapter with an important remark.
