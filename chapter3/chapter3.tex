...
. The studies which will be described in Chapter~\ref{ch:jets} and Chapter~\ref{ch:th_error}, regarding the inclusion of jets data
...
\begin{figure}[htb]     
	\begin{center}
		\includegraphics[width=70mm]{nn.pdf}
	\end{center}
...
%
\comment{Add a short paragraph about hyperopt? Probably not..}
...
The fact that we still get equivalent results provides a strong validation of the {\tt n3fit} environment.
